"""
Risk classification for task execution.
Used by the Control Plane to decide approval flow.
"""
...
def assess_task_risk(task: Any) -> str:
    """
    ...
    # Unknown commands are treated as MEDIUM risk by default
    return "medium"
